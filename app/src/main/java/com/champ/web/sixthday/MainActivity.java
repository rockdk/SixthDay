package com.champ.web.sixthday;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt_custom=findViewById(R.id.custom);
        bt_hori=findViewById(R.id.hori);
        bt_spin=findViewById(R.id.spiner);
       ...
       //custom
        ...
        bt_spin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                progressDialog.setMessage("please wait Content Loading");
        ...
        bt_hori.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ProgressDialog progressDialog=
                        new ProgressDialog(MainActivity.this);
